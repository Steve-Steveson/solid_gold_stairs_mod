...
public class UncutWeatheringCopperStairBlock extends StairBlock implements WeatheringCopper, SteveHasWeatheringCopper {
    ...
    /**
     * Provides "our own" oxidation chain for copper stairs.
     */
    public static Optional<Block> getNextBlock(Block block) {
        if (block == ModBlocks.COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.EXPOSED_COPPER_STAIRS.get());
        } else if (block == ModBlocks.EXPOSED_COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.WEATHERED_COPPER_STAIRS.get());
        } else if (block == ModBlocks.WEATHERED_COPPER_STAIRS.get()) {
    ...
    public static Optional<Block> getPreviousBlock(Block block) {
        if (block == ModBlocks.EXPOSED_COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.COPPER_STAIRS.get());
        } else if (block == ModBlocks.WEATHERED_COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.EXPOSED_COPPER_STAIRS.get());
        } else if (block == ModBlocks.OXIDIZED_COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.WEATHERED_COPPER_STAIRS.get());
        }
        return Optional.empty();
    }
    ...
    /**
     * Gets the waxed variant of a copper stair.
     */
    public static Optional<Block> getWaxedBlock(Block block) {
        if (block == ModBlocks.COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.WAXED_COPPER_STAIRS.get());
        } else if (block == ModBlocks.EXPOSED_COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.WAXED_EXPOSED_COPPER_STAIRS.get());
        } else if (block == ModBlocks.WEATHERED_COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.WAXED_WEATHERED_COPPER_STAIRS.get());
        } else if (block == ModBlocks.OXIDIZED_COPPER_STAIRS.get()) {
            return Optional.of(ModBlocks.WAXED_OXIDIZED_COPPER_STAIRS.get());
        }
        return Optional.empty();
    }
