...
public class CopperSlabBlock extends SlabBlock {
    ...
    public CopperSlabBlock(Properties pProperties, WeatheringCopper.WeatherState weatheringState) {
        super(pProperties);
    ...
    public static Optional<Block> getUnwaxedBlock(Block block) {
        if (block == ModBlocks.WAXED_COPPER_SLAB.get()) {
            return Optional.of(ModBlocks.COPPER_SLAB.get());
        } else if (block == ModBlocks.WAXED_EXPOSED_COPPER_SLAB.get()) {
            return Optional.of(ModBlocks.EXPOSED_COPPER_SLAB.get());
        } else if (block == ModBlocks.WAXED_WEATHERED_COPPER_SLAB.get()) {
            return Optional.of(ModBlocks.WEATHERED_COPPER_SLAB.get());
        } else if (block == ModBlocks.WAXED_OXIDIZED_COPPER_SLAB.get()) {
